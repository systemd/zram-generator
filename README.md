...
``` bash
sudo dnf config-manager --add-repo https://download.opensuse.org/repositories/home:alvistack/Fedora_33/home:alvistack.repo
...
``` bash
cd /etc/yum.repos.d/
wget https://download.opensuse.org/repositories/home:alvistack/CentOS_8/home:alvistack.repo
...
``` bash
echo 'deb http://download.opensuse.org/repositories/home:/alvistack/Debian_10/ /' | sudo tee /etc/apt/sources.list.d/home:alvistack.list
curl -fsSL https://download.opensuse.org/repositories/home:alvistack/Debian_10/Release.key | gpg --dearmor | sudo tee /etc/apt/trusted.gpg.d/home_alvistack.gpg > /dev/null
sudo apt update
...
``` bash
sudo zypper addrepo https://download.opensuse.org/repositories/home:alvistack/openSUSE_Leap_15.3/home:alvistack.repo
sudo zypper refresh
